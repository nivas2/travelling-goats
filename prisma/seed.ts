...
async function main() {
  ...
  const users = await Promise.all([
    prisma.user.create({
      data: {
        id: "user-admin-001",
        phone: "9999999999",
        email: "admin@packalong.in",
        name: "PackAlong Admin",
  ...
  await prisma.faq.createMany({
    data: [
      ...
      { category: "Payment", question: "What payment methods are accepted?", answer: "We accept UPI, credit/debit cards, net banking, and wallet payments through Razorpay. You can also use your PackAlong wallet balance.", order: 1 },
      ...
      { category: "Trip", question: "Who are Trip Captains?", answer: "Trip Captains are experienced travelers vetted by PackAlong. They lead the group, handle logistics, and ensure everyone has a great time.", order: 2 },
